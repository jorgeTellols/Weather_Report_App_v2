...
function WeatherWidget({
  ...
  || !weatherDay4 || !weatherDay5 || !weatherDay6 || !weekWeatherReport) {
    content = <Spinner />;
  } else {
    content = (
      <>
        <div className="first-row">
          <WeatherCard
            ...
            showModal={() => { showModal(weekWeatherReport[0]); }}
          />
        </div>
        <div className="second-row">
          <WeatherMiniCard
            ...
            showModal={() => { showModal(weekWeatherReport[1]); }}
          />
          <WeatherMiniCard
            ...
            showModal={() => { showModal(weekWeatherReport[2]); }}
          />
          <WeatherMiniCard
            ...
            showModal={() => { showModal(weekWeatherReport[3]); }}
          />
          <WeatherMiniCard
            ...
            showModal={() => { showModal(weekWeatherReport[4]); }}
          />
          <WeatherMiniCard
            ...
            showModal={() => { showModal(weekWeatherReport[5]); }}
          />
          <WeatherMiniCard
            ...
            showModal={() => { showModal(weekWeatherReport[6]); }}
          />
        </div>
      </>
    );
