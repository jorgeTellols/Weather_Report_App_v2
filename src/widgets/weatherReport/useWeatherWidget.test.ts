...
const mockWeatherData: Array<Weather> = [
  new Weather('2024-09-01', 'icon1', 'description1', 20, 25, 15, 0.1, 'timezone', 5, 60, 1013),
  new Weather('2024-09-02', 'icon2', 'description2', 22, 26, 17, 0.2, 'timezone', 6, 55, 1015),
];
...
it('should return weather data and put it into todayWeather', async () => {
  mockWeatherService.mockResolvedValue(mockWeatherData);
